...
window.Movement_Controls = window.classes.Movement_Controls = class Movement_Controls extends Scene_Component {
    constructor(context, control_box, canvas=context.canvas) {
        ...
        canvas.addEventListener("mousedown", e=>{
            ...
            onclick(this.mouse.anchor[0], this.mouse.anchor[1]);              // CHANGED HERE clicking function
        });
...
class Transparent_Glass extends Scene_Component {
...
//     }
    ...
    display(graphics_state) {
        ...
        this.shapes['box'].draw(
            graphics_state, 
            center.times(Mat4.translation([0, 1, 0])).times(Mat4.scale([10, 7, 5])),
            this.shape_materials['glass']
        )
    }
}

window.Transparent_Glass = window.classes.Transparent_Glass = Transparent_Glass;